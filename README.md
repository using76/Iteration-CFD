...
적응 메시 세분화(AMR)는 **구현되지 않았고 시작하지도 않았습니다.** SPEC-LIT
§74는 그보다 먼저 와야 하며 그 자체로 결론이 나는 부분을 합니다. 2:1 세분화
...
**주장하지 않는 것.** 아무것도 적응하지 않으므로 적응 시점의 보존 시험도,
제한(restriction)·연장(prolongation)도, 플럭스 연장도, 적응 후 투영도 없습니다.
